...
Modules:
    ...
    ϕv4           — φ-lang v4 decoder. 3-char codes, 19,802 words (legacy fallback).
...
Usage:
    ...
    from shivtext import ϕv4
    ϕv4.decode_v4("a00 a01")  # -> "bigmacman billing"
"""
...
try:
    ϕv4 = importlib.import_module('shivtext.ϕv4')
except (ModuleNotFoundError, ImportError):
    ϕv4 = None
